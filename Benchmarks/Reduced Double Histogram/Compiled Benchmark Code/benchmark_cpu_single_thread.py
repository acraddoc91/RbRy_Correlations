from corrLib import g2ToFile_cpu, g2ToFile_cpu_thread_benchmark
import numpy as np
import time
import os
import scipy
...
benchmark_mat = mat_directory+"reduced_double_histogram_cpu_single_threaded_benchmark"

bin_width = 82.3e-12*12
pulse_spacing = 100e-6
max_pulse_distance = 4
half_tau_bins = np.array([1,2,5,10,20,50,100,200,500,1000])
...
for i in range(len(half_tau_bins)):
    ...
    g2ToFile_cpu_thread_benchmark(data_folder,mat_file,max_time,bin_width,pulse_spacing,max_pulse_distance,1)
